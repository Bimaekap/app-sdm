            ...
            <div class="flex flex-col gap-2 overflow-y-auto pb-6">
                ...
                <div x-data="{ isExpanded: false }" class="flex flex-col">
                    ...
                    <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="user-management-btn"
                        ...
                        <li class="px-1 py-0.5 first:mt-2">
                            <a href="#" class="flex items-center rounded-md gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 
                                focus:outline-none focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 
                ...
                <div x-data="{ isExpanded: false }" class="flex flex-col">
                    ...
                    <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="products-btn" id="products">
                        <li class="px-1 py-0.5 first:mt-2">
                            <a href="#"
                                class="flex items-center rounded-md gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus:outline-none focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">All
                                Products</a>
                        </li>
                        <li class="px-1 py-0.5 first:mt-2">
                            <a href="#"
                                class="flex items-center rounded-md gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus:outline-none focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">Inventory</a>
                        </li>
                        <li class="px-1 py-0.5 first:mt-2">
                            <a href="#"
                                class="flex items-center rounded-md gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus:outline-none focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">Reviews</a>
                        </li>
                    </ul>
                </div>
                ...
                <div x-data="{ isExpanded: false }" class="flex flex-col">
                    ...
                    <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="orders-btn" id="orders">
                        <li class="px-1 py-0.5 first:mt-2">
                            <a href="#"
                                class="flex items-center rounded-md gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus:outline-none focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">
                                <span>Pending</span>
            ...
            <div x-data="{ menuIsOpen: false }" class="mt-auto" x-on:keydown.esc.window="menuIsOpen = false">
                <button type="button"
                    ...
                    <img src="https://penguinui.s3.amazonaws.com/component-assets/avatar-7.webp"
                        class="size-8 object-cover rounded-md" alt="avatar" aria-hidden="true" />
                ...
                <div x-cloak x-show="menuIsOpen"
                    class="absolute bottom-20 right-6 z-20 -mr-1 w-48 border divide-y divide-neutral-300 border-neutral-300 bg-white dark:divide-neutral-700 dark:border-neutral-700 dark:bg-stone-950 rounded-md md:-right-44 md:bottom-4"
